...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        h1 = self.addHost('h1', ip='10.0.1.1/16', mac='ea:e9:78:fb:fd:01')
        h2 = self.addHost('h2', ip='10.0.1.2/16', mac='ea:e9:78:fb:fd:02')
        h3 = self.addHost('h3', ip='10.0.2.2/16', mac='ea:e9:78:fb:fd:03')
        h4 = self.addHost('h4', ip='0.0.0.0', mac='ea:e9:78:fb:fd:04')
        h5 = self.addHost('h5', ip='10.0.2.1/16', mac='ea:e9:78:fb:fd:05')
